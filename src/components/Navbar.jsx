      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[23px] font-bold cursor-pointer flex '>
            Ady &nbsp;
            <span className='sm:block hidden'> | Banik</span>
          </p>
        </Link>
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          ...
          <li className="text-secondary hover:text-white text-[18px] font-medium cursor-pointer">
            <a href="#" onClick={handleResumeClick}>Resume</a>
          </li>
        </ul>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          >
            <ul className='list-none flex justify-end items-start flex-1 flex-col gap-4'>
              ...
              <li className="font-poppins font-medium cursor-pointer text-[16px] text-secondary hover:text-white" onClick={handleResumeClick}>
                <a href="#">Resume</a>
              </li>
            </ul>
          </div>
